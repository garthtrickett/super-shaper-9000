    ...
    return html`
            ...
            ${!this.isRendererReady ? html`
              <div class="absolute inset-0 z-50 flex flex-col items-center justify-center bg-zinc-950">
                <svg class="w-10 h-10 animate-spin text-blue-500 mb-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                  <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                </svg>
                <h2 class="text-zinc-200 font-black tracking-widest uppercase text-sm mb-2">Starting Engine</h2>
                <p class="text-zinc-500 font-mono text-[10px] text-center max-w-xs uppercase">Loading WebAssembly & WGPU...</p>
              </div>
            ` : ''}
