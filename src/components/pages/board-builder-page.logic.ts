...
export const BoardModelSchema = S.Struct({
  ...
  bgImageVisible: S.Boolean,
  bgImageScale: S.Number,
  bgImageOffsetX: S.Number,
  bgImageOffsetZ: S.Number,
  bgImageOpacity: S.Number,
  bgImageAspectRatio: S.Number,
});
