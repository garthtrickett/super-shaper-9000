  ...
  private _renderAccordion(title: string, content: unknown, open = false) {
    ...
    return html`
      <div class="p-6 flex flex-col h-full bg-zinc-900 overflow-y-auto custom-scrollbar relative">
        <div class="sticky top-0 z-50 flex justify-end pointer-events-none h-0 overflow-visible">
          ${this.isProcessing ? html`
            <div class="flex items-center gap-2 bg-zinc-900/90 text-blue-400 px-3 py-1.5 rounded-full shadow-lg border border-blue-500/30 backdrop-blur-md translate-y-2 translate-x-2">
